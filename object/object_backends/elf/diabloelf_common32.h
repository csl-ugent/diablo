...
void ElfReadCommon32(FILE * fp, void * hdr, t_object * obj, Elf32_Shdr ** shdr_ret, Elf32_Sym ** symbol_table_ret, Elf32_Sym ** dynamic_symbol_table_ret, t_uint32 * numsyms_ret, char ** strtab_ret, char ** sechdrstrtab_ret, t_section *** sec_ret, t_symbol *** lookup, t_symbol *** dynamic_lookup, t_bool switch_endian, t_bool read_debug, Elf32_HeaderInfo const * const hinfo);
#endif
#endif
