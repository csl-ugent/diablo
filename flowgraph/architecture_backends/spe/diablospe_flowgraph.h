...
#ifndef SPE_FLOWGRAPH_H
#define SPE_FLOWGRAPH_H

#include <diablospe.h>

/*! \addtogroup SPE_BACKEND @{ */

void SpeFlowgraphSection(t_section *sec);
void SpeFlowgraph(t_object *obj);
void SpeMakeAddressProducers(t_cfg *cfg);
