...
/*!\addtogroup PPC_BACKEND */
/*@{ */
#include <diabloobject.h>

#ifndef PPC_DISASSEMBLE_H
#define PPC_DISASSEMBLE_H
/* Includes {{{ */
...
void PpcDisassembleSection(t_section * code);
void DiabloFlowgraphPpcCfgCreated (t_object *obj, t_cfg *cfg);
#endif
/*@}*/
