...
#ifndef SKELETON_REGISTERS_H
#define SKELETON_REGISTERS_H

#include <diabloflowgraph.h> 

#define SKELETON_REG_INVALID   254
#define SKELETON_REG_NONE      255

/* general purpose registers */
#define SKELETON_REG_R0		0

/* function prototypes */
t_string SkeletonRegisterName(t_reg reg);
