...
#define PREFIX_FOR_LINKED_IN_PROFILING_OBJECT "LINKED_IN_PROFILING_OBJECT_"
#define FINAL_PREFIX_FOR_LINKED_IN_PROFILING_OBJECT PREFIX_FOR_LINKED_IN_PROFILING_OBJECT LINKIN_IDENTIFIER_PREFIX
