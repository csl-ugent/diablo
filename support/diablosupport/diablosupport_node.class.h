...
IMEMBER(t_edge *, succ_first, SUCC_FIRST)
/*! The last outgoing edge */
MEMBER(t_edge *, succ_last, SUCC_LAST)
/*! The first incoming edge */
IMEMBER(t_edge *, pred_first, PRED_FIRST)
