...
#define ClassOffsetOf(TYPE, MEMBER) ((size_t) &((TYPE *)0)-> _concat_(_hidden_,MEMBER))
#define OffsetOf(TYPE, MEMBER) ((size_t) &((TYPE *)0)->MEMBER)
#define ClassCast(TYPE, INST) (&(INST->_concat_(_hidden_parent_,TYPE)))
#define GetBase(x)   (&(x->_hidden_parent))
#endif

/* VC++ does not allow explicit struct casts */
#ifdef _MSC_VER
#define RETVAL_CAST(x)
#define RETVAL_TYPE(x) x
#define ORIG_CAST(x)
#else
#define RETVAL_CAST(x) (renamed_##x)
#define RETVAL_TYPE(x) renamed_##x
#define ORIG_CAST(x) (x)
#endif
...
#define MEMBER(x,y,z) static inline x _concat3_(_concat_(CLASS,_field_select_prefix),_,z) (t_CLASS * c) { return c-> _concat_(_hidden_,y); }
#define MEMBERU(x,y,z) MEMBER(x,y,z)
#else
#ifdef GEN_CODE
#define MEMBER(x,y,z) x _concat3_(_concat_(CLASS,_field_select_prefix),_,z) (t_CLASS * c) { return c-> _concat_(_hidden_,y); }
#define MEMBERU(x,y,z) MEMBER(x,y,z)
#else /* GEN_PROTO */
#define MEMBER(x,y,z) x _concat3_(_concat_(CLASS,_field_select_prefix),_,z) (t_CLASS * c);
#define MEMBERU(x,y,z) MEMBER(x,y,z)
#endif
#endif
...
#define DESTRUCTOR(b) static void _concat_(_concat_(CLASS,_function_prefix),Free) (t_CLASS * to_free) { MANAGER_TYPE MANAGER_NAME = to_free-> _concat_(_hidden_,MANAGER_NAME); t_manager_callback * free_cb=MANAGER_NAME -> _concat_(_hidden_,MANAGER_FIELD) .free; while(free_cb && free_cb->prior<0) { free_cb->cb_func((void *) to_free,free_cb->cb_user_data); free_cb=free_cb->next; } { b } while(0); Free(to_free); while(free_cb) { free_cb->cb_func(NULL,free_cb->cb_user_data); free_cb=free_cb->next; } } static void _concat_(_concat_(CLASS,_function_prefix),BeforeFree) (t_CLASS * to_free) { MANAGER_TYPE MANAGER_NAME = to_free-> _concat_(_hidden_,MANAGER_NAME); t_manager_callback * free_cb=MANAGER_NAME -> _concat_(_hidden_,MANAGER_FIELD) .free; while(free_cb && free_cb->prior<0) { free_cb->cb_func((void *) to_free,free_cb->cb_user_data); free_cb=free_cb->next; } } 

extern void *global_hack_dup_orig;

#define DUPLICATOR(b) static t_CLASS * _concat_(_concat_(CLASS,_function_prefix),Dup) (t_CLASS * to_dup) { t_CLASS * ret; MANAGER_TYPE MANAGER_NAME = to_dup-> _concat_(_hidden_,MANAGER_NAME); t_manager_callback * dup_cb=MANAGER_NAME -> _concat_(_hidden_,MANAGER_FIELD) .dup; while(dup_cb && dup_cb->prior<0) { dup_cb->cb_func((void *) to_dup,dup_cb->cb_user_data); dup_cb=dup_cb->next; } ret=Malloc(sizeof(t_CLASS)); memcpy(ret,to_dup,sizeof(t_CLASS)); { b } while(0); global_hack_dup_orig=to_dup; while(dup_cb) { dup_cb->cb_func((void *) ret,dup_cb->cb_user_data); dup_cb=dup_cb->next; } return ret; } static void _concat_(_concat_(CLASS,_function_prefix),BeforeDup) (t_CLASS * to_dup) { MANAGER_TYPE MANAGER_NAME = to_dup-> _concat_(_hidden_,MANAGER_NAME); t_manager_callback * dup_cb=MANAGER_NAME -> _concat_(_hidden_,MANAGER_FIELD) .dup; while(dup_cb && dup_cb->prior<0) { dup_cb->cb_func((void *) to_dup,dup_cb->cb_user_data); dup_cb=dup_cb->next; } } static void _concat_(_concat_(CLASS,_function_prefix),AfterDup) (t_CLASS * to_dup, t_CLASS * ret) { MANAGER_TYPE MANAGER_NAME = to_dup-> _concat_(_hidden_,MANAGER_NAME); t_manager_callback * dup_cb=MANAGER_NAME -> _concat_(_hidden_,MANAGER_FIELD) .dup; while(dup_cb && dup_cb->prior<0) { dup_cb=dup_cb->next; } global_hack_dup_orig=to_dup; while(dup_cb) { dup_cb->cb_func((void *) ret,dup_cb->cb_user_data); dup_cb=dup_cb->next; } }
...
#ifdef GEN_CODE_STATIC
#define MEMBER(x,y,z) static RETVAL_TYPE(x) _concat3_(_concat_(CLASS,_field_select_prefix),_,z) (renamed_t_CLASS * c) { return RETVAL_CAST(x) (GET_PARENT(c)-> _concat_(_hidden_,y)); }
#define MEMBERU(x,y,z) MEMBER(x,y,z)
#else
#ifdef GEN_CODE 
#define MEMBER(x,y,z) RETVAL_TYPE(x) _concat3_(_concat_(CLASS,_field_select_prefix),_,z) (renamed_t_CLASS * c) { return RETVAL_CAST(x) (GET_PARENT(c)-> _concat_(_hidden_,y)); }
#define MEMBERU(x,y,z) MEMBER(x,y,z)
#else /* GEN_PROTO */
#define MEMBER(x,y,z) RETVAL_TYPE(x) _concat3_(_concat_(CLASS,_field_select_prefix),_,z) (renamed_t_CLASS * c); 
#define MEMBERU(x,y,z) MEMBER(x,y,z)
#endif
#endif
...
#ifdef GEN_CODE_STATIC
#define MEMBER(x,y,z) static inline void _concat3_(_concat_(CLASS,_field_select_prefix),_SET_,z) (renamed_t_CLASS * c, RETVAL_TYPE(x) val) { ((GET_PARENT(c))-> _concat_(_hidden_,y))=ORIG_CAST(x) val; }
#define MEMBERU(x,y,z) static inline void _concat3_(_concat_(CLASS,_field_select_prefix),_SET_,z) (renamed_t_CLASS * c, RETVAL_TYPE(x) val) { _concat3_(_concat_(CLASS,_field_select_prefix),Update,z)(c,val); ((GET_PARENT(c))-> _concat_(_hidden_,y))=ORIG_CAST(x) val; }
#else
#ifdef GEN_CODE 
#define MEMBER(x,y,z) void _concat3_(_concat_(CLASS,_field_select_prefix),_SET_,z) (renamed_t_CLASS * c, RETVAL_TYPE(x) val) { ((GET_PARENT(c))-> _concat_(_hidden_,y))=ORIG_CAST(x) val; }
#define MEMBERU(x,y,z) void _concat3_(_concat_(CLASS,_field_select_prefix),_SET_,z) (renamed_t_CLASS * c, RETVAL_TYPE(x) val) { _concat3_(_concat_(CLASS,_field_select_prefix),Update,z)(c,val); ((GET_PARENT(c))-> _concat_(_hidden_,y))=ORIG_CAST(x) val; }
#else /* GEN_PROTO */
#define MEMBER(x,y,z) void _concat3_(_concat_(CLASS,_field_select_prefix),_SET_,z) (renamed_t_CLASS * c, RETVAL_TYPE(x) val);
#define MEMBERU(x,y,z) MEMBER(x,y,z)
#endif
#endif
...
#ifdef GEN_CODE_STATIC
#define FUNCTION0(x,y) static inline RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) () { return RETVAL_CAST(x) _concat_(_concat_(BASECLASS,_function_prefix),y)(); }
#else
#ifdef GEN_CODE 
#define FUNCTION0(x,y) RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) () { return RETVAL_CAST(x) _concat_(_concat_(BASECLASS,_function_prefix),y)(); }
#else /* GEN_PROTO */
#define FUNCTION0(x,y) RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) ();
#endif
#endif

#ifdef GEN_CODE_STATIC
#define FUNCTION1(x,y,z) static inline RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a) { return RETVAL_CAST(x) _concat_(_concat_(BASECLASS,_function_prefix),y)((z) a); }
#else
#ifdef GEN_CODE 
#define FUNCTION1(x,y,z) RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a) { return RETVAL_CAST(x) _concat_(_concat_(BASECLASS,_function_prefix),y)((z) a); }
#else /* GEN_PROTO */
#define FUNCTION1(x,y,z) RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a); 
#endif
#endif

#ifdef GEN_CODE_STATIC
#define FUNCTION2(x,y,z,u) static inline RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a, renamed_##u b) { return RETVAL_CAST(x) _concat_(_concat_(BASECLASS,_function_prefix),y)((z) a, (u) b); }
#else
#ifdef GEN_CODE 
#define FUNCTION2(x,y,z,u) RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a, renamed_##u b) { return RETVAL_CAST(x) _concat_(_concat_(BASECLASS,_function_prefix),y)((z) a, (u) b); }
#else /* GEN_PROTO */
#define FUNCTION2(x,y,z,u) RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a, renamed_##u b); 
#endif
#endif
								       
#ifdef GEN_CODE_STATIC
#define FUNCTION3(x,y,z,u,v) static inline RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a, renamed_##u b, renamed_##v c) { return RETVAL_CAST(x) _concat_(_concat_(BASECLASS,_function_prefix),y)((z) a, (u) b, (v) c); }
#else
#ifdef GEN_CODE 
#define FUNCTION3(x,y,z,u,v) RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a, renamed_##u b, renamed_##v c) { return RETVAL_CAST(x) _concat_(_concat_(BASECLASS,_function_prefix),y)((z) a, (u) b, (v) c); }
#else /* GEN_PROTO */
#define FUNCTION3(x,y,z,u,v) RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a, renamed_##u b, renamed_##v c);
#endif
#endif
								       
#ifdef GEN_CODE_STATIC
#define FUNCTION4(x,y,z,u,v,w) static inline RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a, renamed_##u b, renamed_##v c, renamed_##w d) { return RETVAL_CAST(x) _concat_(_concat_(BASECLASS,_function_prefix),y)((z) a, (u) b, (v) c, (w) d); }
#else
#ifdef GEN_CODE 
#define FUNCTION4(x,y,z,u,v,w) RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a, renamed_##u b, renamed_##v c, renamed_##w d) { return RETVAL_CAST(x) _concat_(_concat_(BASECLASS,_function_prefix),y)((z) a, (u) b, (v) c, (w) d); }
#else /* GEN_PROTO */
#define FUNCTION4(x,y,z,u,v,w) RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a, renamed_##u b, renamed_##v c, renamed_##w d);
#endif
#endif

#ifdef GEN_CODE_STATIC
#define FUNCTION5(x,y,z,u,v,w,r) static inline RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a, renamed_##u b, renamed_##v c, renamed_##w d, renamed_##r e) { return RETVAL_CAST(x) _concat_(_concat_(BASECLASS,_function_prefix),y)((z) a, (u) b, (v) c, (w) d, (r) e); }
#else
#ifdef GEN_CODE 
#define FUNCTION5(x,y,z,u,v,w,r) RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a, renamed_##u b, renamed_##v c, renamed_##w d, renamed_##r e) { return RETVAL_CAST(x) _concat_(_concat_(BASECLASS,_function_prefix),y)((z) a, (u) b, (v) c, (w) d, (r) e); }
#else /* GEN_PROTO */
#define FUNCTION5(x,y,z,u,v,w,r) RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a, renamed_##u b, renamed_##v c, renamed_##w d, renamed_##r e);
#endif
#endif

#ifdef GEN_CODE_STATIC
#define FUNCTION6(x,y,z,u,v,w,r,s) static inline RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a, renamed_##u b, renamed_##v c, renamed_##w d, renamed_##r e, renamed_##s f) { return RETVAL_CAST(x) _concat_(_concat_(BASECLASS,_function_prefix),y)((z) a, (u) b, (v) c, (w) d, (r) e, (s) f); }
#else
#ifdef GEN_CODE 
#define FUNCTION6(x,y,z,u,v,w,r,s) RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a, renamed_##u b, renamed_##v c, renamed_##w d, renamed_##r e, renamed_##s f) { return RETVAL_CAST(x) _concat_(_concat_(BASECLASS,_function_prefix),y)((z) a, (u) b, (v) c, (w) d, (r) e, (s) f); }
#else /* GEN_PROTO */
#define FUNCTION6(x,y,z,u,v,w,r,s) RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a, renamed_##u b, renamed_##v c, renamed_##w d, renamed_##r e, renamed_##s f);
#endif
#endif

#ifdef GEN_CODE_STATIC
#define FUNCTION7(x,y,z,u,v,w,r,s,t) static inline RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a, renamed_##u b, renamed_##v c, renamed_##w d, renamed_##r e, renamed_##s f, renamed_##t g) { return RETVAL_CAST(x) _concat_(_concat_(BASECLASS,_function_prefix),y)((z) a, (u) b, (v) c, (w) d, (r) e, (s) f, (t) g); }
#else
#ifdef GEN_CODE 
#define FUNCTION7(x,y,z,u,v,w,r,s,t) RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a, renamed_##u b, renamed_##v c, renamed_##w d, renamed_##r e, renamed_##s f, renamed_##t g) { return RETVAL_CAST(x) _concat_(_concat_(BASECLASS,_function_prefix),y)((z) a, (u) b, (v) c, (w) d, (r) e, (s) f, (t) g); }
#else /* GEN_PROTO */
#define FUNCTION7(x,y,z,u,v,w,r,s,t) RETVAL_TYPE(x) _concat_(_concat_(CLASS,_function_prefix),y) (renamed_##z a, renamed_##u b, renamed_##v c, renamed_##w d, renamed_##r e, renamed_##s f, renamed_##t g);
#endif
#endif
