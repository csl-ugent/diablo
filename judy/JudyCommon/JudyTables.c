...
// @(#) $Revision: 1.2 $ $Source: /cvs/diablo/judy/JudyCommon/JudyTables.c,v $
...
FUNCTION int main()
{
    ...
    fprintf(fd,"// @(#) From generation tool: $Revision: 1.2 $ $Source: /cvs/diablo/judy/JudyCommon/JudyTables.c,v $\n");
    fprintf(fd,"//\n\n");
